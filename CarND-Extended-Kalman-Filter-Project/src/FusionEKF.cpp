...
FusionEKF::FusionEKF() {
  ...
  */
   ...
   ekf_.P_ <<1, 0 , 0, 0,
	     ...
	     0, 0 , 1000, 0,
	     0, 0 , 0, 1000;	     
  //cout <<"End of constructor in Fusion EKF" << std::endl;
}
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
	//cout<<"Inside Radar initializer"<<endl;
	...
	ekf_.x_[3] = vy;
      ...
      Initialize state.
      */
	//cout<<"Inside Laser initializer"<<endl;
  ...
  //cout << "Initialization completed in Fusion EKF" << std::endl;
    return;
  }
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
       //cout<<"In radar fusionekf"<<endl;
    //ekf_.H_ = MatrixXd(3,4);
    ekf_.H_ = tools.CalculateJacobian(ekf_.x_);
     //cout<<"After Jacobian"<<endl;
    //ekf_.R_ = MatrixXd(3,3);
    ekf_.R_ = R_radar_;
    ekf_.UpdateEKF(measurement_pack.raw_measurements_);
    
  } else {
   //cout<<"In laser fusionekf"<<endl;
